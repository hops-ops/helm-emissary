...
PACKAGE ?= helm-emissary
XRD_DIR := apis/emissary
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/emissary/standard.yaml
...
EXAMPLES := \
    examples/emissary/minimal.yaml:: \
    examples/emissary/standard.yaml::
...
render\:%:
	@example="examples/emissary/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
